...
public class StripPaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amount = getIntent().getDoubleExtra(getString(R.string.amount), 0.0);
        txtTotal.setText(getString(R.string.totalamount) + sessionManager.getStringData(SessionManager.currency) + new DecimalFormat("##.##").format(amount));

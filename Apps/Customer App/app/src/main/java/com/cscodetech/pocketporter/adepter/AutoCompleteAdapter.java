...
public class AutoCompleteAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {
    ...
    private List<AutocompletePrediction> getAutocomplete(CharSequence constraint) throws ExecutionException, InterruptedException, TimeoutException {
...
//                        .setLocationRestriction(bounds)
        ...
        if (results.isSuccessful() && results.getResult() != null) {
            ...
            List<AutocompletePrediction> autocompletePredictions=null;
